...
（＊）気象庁が公開している衛星画像は、あらかじめWebメルカトルに投影されたタイル画像として配信されているため、それらを縦横必要な枚数取得後に連結し、GCPにより作成した基準天気図（GeoTIFF）の格子へ投影変換して天気図の投影座標系（北緯60度、東経140 度を基準としたポーラーステレオ図法(https://www.data.jma.go.jp/suishin/shiyou/pdf/no12201) に変換し、天気図の表示範囲に対応させて切り取る加工
